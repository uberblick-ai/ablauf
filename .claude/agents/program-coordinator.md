...
description: Program coordinator role for one program issue from the ablauf program queue; picks and claims its own item, and acts only when given a role and a session or run identity.
---
