---
name: issue-preparer
description: Issue preparer role for one item from the ablauf issue-preparation queue; picks and claims its own item, and acts only when given a role and a session or run identity.
---
